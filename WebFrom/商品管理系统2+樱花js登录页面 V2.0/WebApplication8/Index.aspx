...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:MarketConnectionString %>' ProviderName='<%$ ConnectionStrings:MarketConnectionString.ProviderName %>' DeleteCommand="DELETE FROM [ProductInfo] WHERE [ProductID] = @ProductID" SelectCommand="SELECT * FROM [ProductInfo]"></asp:SqlDataSource>
        </div>
